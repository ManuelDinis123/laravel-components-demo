...
<body id="body-pd">
    <header class="header" id="header">
        ...
        <div class="header_img" onclick="window.open('https\:\/\/github.com/ManuelDinis123/laravel-components-demo', '_blank').focus();"> <i class='bx bxl-github'></i> </div>
    </header>
        ...
        <nav class="nav">
            <div>
                ...
                <div class="nav_list">
                    ...
                    <a href="/forms" class="nav_link {{ $active == 'forms' ? 'active' : '' }}">
